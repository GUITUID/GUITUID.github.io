...
<h2 id="résumé"><i class="icon-doc-text">Résumé</i></h2>
...
<tr>
  <td><i class="icon-keyboard"> 2009 </i></td>
  <td>BTS Informatique de Gestion: Développeur D’applications</td>
</tr>
<tr>
  <td><i class="icon-hammer"> 2006  </i></td>
  <td>Études notariales (1ière année, École Notariale de Paris)</td>
</tr>
<tr>
  <td><i class="icon-keyboard"> 2005    </i></td>
  <td>BAC STT: Informatique de Gestion</td>
</tr>
</tbody></table>

<h2 id="expériences-professionnelles"><i class="icon-briefcase">Expériences professionnelles</i></h2>
...
<thead>
<tr>
  <th><h4><i class="icon-doc"> Belle Pivoine</i><h4></th>
...
<h3 id="accenture-technology-solutions"><i class="icon-bookmark"> Accenture Technology Solutions</i></h3>
...
<thead>
<tr>
  <th><h4><i class=" icon-fire"> GRDF</i></h4></th>
...
<thead>
<tr>
  <th><h4><i class="icon-money"> La Banque Postale</i></h4></th>
...
<thead>
<tr>
  <th><h4><i class="icon-money"> Axa</i></h4></th>
...
<thead>
<tr>
  <th><h4><i class="icon-mobile"> Orange</i></h4></th>
...
<div style="page-break-before:always">&nbsp;</div> 
<h3 id="mobibase"><i class="icon-bookmark"> Mobibase</i></h3>
...
<thead>
<tr>
  <th><h4><i class="icon-mobile"> Mobibase</i></h4></th>
...
<h2 id="langues"><i class=" icon-quote-right">Langues</i></h2>
...
<h2 id="compétences"><i class="icon-wrench">Compétences</i></h2>
...
<h2 id="projets-personnels"><i class="icon-puzzle">Projets personnels</i></h2>
...
<h2 id="centres-dintérêt"><i class="icon-tag">Centres d’intérêt</i></h2>
